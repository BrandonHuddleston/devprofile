...
inquirer
    ...
    .then(function ({ username, color }) {
        ...
        axios.get(queryUrl).then(function (res) {
            ...
            // writes HTML File
            fs.writeFile('github.html', `<!DOCTYPE html>
            <html>
            <head>
              <meta charset="utf-8">
            ...
            <hr>
            <img src="${githubData.avatar_url} alt="profile-pic" width ="200px" height = "200px">
            <br>
            ...
            <h3>Following:</h3> ${githubData.following}
                ...
                // creates PDF file
                const html = fs.readFileSync('./github.html', 'utf8');
